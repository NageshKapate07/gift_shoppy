...
public class OrderConfirm {
	...
	public void sendEmail(String to,Orders o) {
		...
		String msgbody="Thanks for Placing order with Gift Mania your order placed Successfully productname="+o.getProd().getTitle()+" Total Price ="+o.getProd().getPrice();
