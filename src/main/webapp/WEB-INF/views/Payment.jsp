                        ...
                        <div class="collapse show p-3 pt-0" id="collapseExample">
                            <div class="row">
                                <div class="col-lg-5 mb-lg-0 mb-3">
                                    ...
                                    <p class="mb-0"><span class="fw-bold">Product:</span><span class="c-green">: ${prod.product.name}</span>
                                    </p>
                                    <p class="mb-0">
                                        <span class="fw-bold">Price:</span>
                                        <span class="c-green">:${prod.product.price}</span>
                                    </p>
                                    <p class="mb-0">Description: ${prod.product.description}</p>
                                </c:forEach>
                                <hr>
                                ...
                                <div class="col-lg-7">
                                    <form action='<spring:url value="/Customer/pay"/>' method="post" class="form">
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form__div">
