		...
		<form action='<spring:url value="/signup"/>' method="post"
			...
			<div class="row jumbotron">
				...
				<div class="col-sm-6 form-group">
					<label for="name-f">Full Name</label> <input type="text"
				...
				<div class="col-sm-6 form-group">
					<label for="address-1">Address Line-1</label> <input type="address"
						class="form-control" name="locality" id="locality"
				...
				<div class="col-sm-6 form-group">
					<label for="Date">Date Of Birth</label> <input type="Date"
						name="dob" class="form-control" id="dob" placeholder="" required>
					<p>${requestScope.doberror}</p>
				</div>
				<div class="col-sm-6 form-group">
				...
				<div class="col-sm-2 form-group">
					<label for="cod">Country code</label> <select type="text"
						name="pcode" class="form-control browser-default custom-select">
